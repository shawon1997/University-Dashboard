...
function Navigation() {
  return (
    <div className='d-flex' style={{height: "60px", padding: "15px", width: "100%", borderRadius: "6px", backgroundColor: "#1d1e3e", color: "white"}}>
      <Navbar expand="lg" style={{width: "100%", backgroundColor: "transparent"}}>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ml-auto" style={{display: 'flex', justifyContent: 'space-between', width: '100%'}}>
            ...
            <Nav.Link as={Link} to="/admin-dashboard" style={{color: "white", textDecoration: "none"}}>Admin Dashboard</Nav.Link>
            ...
            <Nav.Link as={Link} to="/my-profile" style={{color: "white", textDecoration: "none"}}>My Profile</Nav.Link>
            <Nav.Link as={Link} to="/performance" style={{color: "white", textDecoration: "none"}}>My Performance</Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Navbar>
    </div>
